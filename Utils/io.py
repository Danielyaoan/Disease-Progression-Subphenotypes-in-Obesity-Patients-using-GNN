...
import pickle
import os
from Models import GCN, GAT, GraphSAGE, DGCN, DIGCN, GAT_batch, GraphSAGE_batch, DIGCN_batch, DGCN_batch, Magnet_batch, GCN_batch
...
def load_data(path_dataset, path_adj_matrix, k):
    ...
    columns_to_drop = ['PATID', 'ADMIT_DATE', 'ENCID', 'BMI_DIFF']#, 'current_status'
    ...
    label = df_features['BMI_DIFF'].astype(int)
