            ...
            for metric in param_grid["metric"]:
                # for max_iter in param_grid["max_iter"]:
                    for tol in param_grid["tol"]:
                        ...
                        row.append([k, metric, tol, db_score, flat_score])



    temp = pd.DataFrame(row, columns=['k', 'metric', 'tol', 'db_score', 'flat_score'])
    temp.to_csv(f'./score_results/search_graphsage_k={k}_tol_dbi.csv', index=False)
